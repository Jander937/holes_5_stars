...
public class SecurityConfig {
    ...
    SecurityFilterChain filterChain(HttpSecurity http) throws Exception{
        http
                ...
                .requestMatchers(HttpMethod.POST, "/api/suite/crear", "/api/hotels").hasAuthority("Administrador")
                .requestMatchers(HttpMethod.GET,"/api/moreReserved", "/api/reservation").hasAnyAuthority("Administrador" , "Usuario", "Invitado")
                .requestMatchers(HttpMethod.GET,"/api/suite/listarId/**").hasAnyAuthority("Administrador" , "Usuario", "Invitado")
                .requestMatchers(HttpMethod.DELETE,"/api/suites/**", "/api/hotels/**").hasAuthority("Administrador")
                .requestMatchers(HttpMethod.PUT, "/api/suite/actualizar").hasAuthority("Administrador")
